...
#define CONTAINER_HEIGHT 8.0 // Height of the container in inches
...
void loop() {
  ...
  bool pumpOn = waterLevel < 80; // Threshold set to 80% of the container height
  ...
  lcd.setCursor(0, 0);
  l     cd.print("Computer Engineering");
  lcd.setCursor(0, 1);
  lcd.print("ND2 - Smart pump");
  lcd.setCursor(0, 2);
